...
class ConfigurationClassBeanDefinitionReader {
	...
	private void loadBeanDefinitionsForConfigurationClass(
		...
		// 调用在解析Import时放入的ImportDefinitionRegister的registerBeanDefinitions方法
	...
	private void loadBeanDefinitionsForBeanMethod(BeanMethod beanMethod) {
		...
		// 创建一个ConfigurationClassBeanDefinition，标识为通过@Bean注解注册到的bean
		...
		// 一下逻辑为拿出@Bean中的属性值填充到BeanDefinition中，最后注册到容器中
